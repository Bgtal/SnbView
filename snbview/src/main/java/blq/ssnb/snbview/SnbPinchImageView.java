...
public class SnbPinchImageView extends ImageView {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == SnbPinchImageView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(SnbPinchImageView pinchImageView);
    }
    ...
    public SnbPinchImageView(Context context) {
        super(context);
        initView();
    }

    public SnbPinchImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public SnbPinchImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(SnbPinchImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(SnbPinchImageView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(SnbPinchImageView.this);
            }
            return true;
        }
    });
